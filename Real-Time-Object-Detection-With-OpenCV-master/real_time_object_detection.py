...
CLASSES = ["aeroplane","fan", "bicycle", "bird", "boat",
           "cap","bottle", "car", "cat", "chair", "cow", "diningtable",
           "dog", "horse","person", "pottedplant", "sheep",
           "sofa", "train", "tvmonitor", "cellphone", "motorbike", "train", "traffic light",
           "stop sign", "pizza", "orange", "apple", "laptop","bus"]
